  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (user) {
        ...
        // If we have a session, user is auto-confirmed (email verification disabled)
        if (session) {
          setMessage({
            type: 'success',
          ...
          // Email verification is enabled but we'll still show success
          setMessage({
            type: 'success',
            content: 'Account created! If email confirmation is required, please check your email. Otherwise, try logging in.',
          })
        }
      }
